  ...
  cssContent = ''
    ...
    * {
    ...
    body {
        ...
        line-height: 1.2; /* tighter line height for denser text */
    ...
    body {
        ...
        --chatbar-height: 36px !important; /* height of the chatbar (52px by default, 47px recommended for aligned, 56px recommended for separated) */
    }
    ...
    @container body style(--panel-labels: on) {
        .visual-refresh {
            ...
            .scroller_ef3116 {
                padding-top: calc(var(--custom-guild-list-padding) - 4px);
            }
    ...
    @container body style(--unrounding: on) {
        /* border radius already removed globally */
        ...
        /* webkit scrollbar already handled by global border-radius rule */
    }
  '';
in {
