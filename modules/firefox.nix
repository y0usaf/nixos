{
  ...
  commonSettings = {
    ...
    "gfx.webrender.all" = if (builtins.elem "nvidia" profile.features) then false else true;
    "media.hardware-video-decoding.enabled" = if (builtins.elem "nvidia" profile.features) then false else true;
    "media.ffmpeg.vaapi.enabled" = if (builtins.elem "nvidia" profile.features) then false else true;
    "layers.acceleration.disabled" = if (builtins.elem "nvidia" profile.features) then true else false;
