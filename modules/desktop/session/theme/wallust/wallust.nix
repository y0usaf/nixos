...
in {
  ...
  config = {
    ...
    bayt.users."${config.user.name}" =
      {
        files = lib.mapAttrs (_: content: {text = content;}) (({
            cmusEnabled ? false,
            ...
            ".config/wallust/templates/colors.css" = ''
            ...
            # Pywal-compatible colors.json for pywalfox
            ".config/wallust/templates/colors.json" = ''              {
              "wallpaper": "{{wallpaper}}",
              "alpha": "{{alpha}}",
              "special": {
              "background": "{{background}}",
            ...
            ".config/wallust/templates/foot-colors.ini" = ''
              [colors-dark]
            ...
            ".config/wallust/templates/shell-colors.sh" = ''
            ...
            # Zellij templates
            ".config/wallust/templates/zellij-config.kdl" = ({zjstatusEnabled ? false}: ''
            ...
            ".config/wallust/templates/zellij-layout.kdl" = ''
              layout {
            ...
            ".config/wallust/templates/discord-colors.css" = ''
            ...
            ".config/wallust/templates/niri-borders.kdl" = ''
              layout {
                border {
                  on
                  active-color "{{ cursor }}"
            ...
            ".config/wallust/templates/vicinae-colors.toml" = ''
              [meta]
              name = "Wallust Auto"
            ...
            ".config/wallust/templates/cmus-colors.theme" = ''
              # Base colors
            ...
            ".config/wallust/templates/gtk-colors.css" = ''
            ...
            # Obsidian Shimmering Focus theme colors
            ".config/wallust/templates/obsidian-colors.css" = ''
            ...
            ".config/wallust/templates/gpuishell-theme.toml" = ''
              font_size_base = 13.0
            ...
            ".config/wallust/templates/rudo-theme.toml" = ''
              background = "{{ background }}"
              foreground = "{{ foreground }}"
              cursor = "{{ cursor }}"
            ...
            ".config/wallust/templates/rudo-osc.sh" = ''
            ...
            vestopkEnabled = lib.attrByPath ["user" "programs" "discord" "vesktop" "enable"] false config;
          });
      }
