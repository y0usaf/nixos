...
in {
  options.user.appearance.wallust = {
    defaultTheme = lib.mkOption {
      type = lib.types.str;
      default = "dopamine";
      description = "Default theme to apply on login. Can be a custom colorscheme name (dopamine, sunset-red) or a built-in wallust theme (Synthwave, Tokyo-Night, etc.)";
    };
  };
