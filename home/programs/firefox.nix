...
###############################################################################
{
  ...
  userChromeCss = ''
    /* Qutebrowser-inspired minimal Firefox CSS */
    ...
    :root {
        ...
        --hover-transition: opacity 0.2s ease;
    }
    ...
    * {
    ...
    /* QUTEBROWSER-LIKE MINIMALISM */
    
    /* Hide tab bar completely - Qutebrowser style */
    #TabsToolbar {
    ...
    /* Hide navigation bar by default, show on hover/focus */
    #nav-bar {
        opacity: 0 !important;
    ...
    /* Show nav bar on hover or when focused */
    #nav-bar:hover,
    #nav-bar:focus-within,
    #urlbar[focused] ~ #nav-bar,
    #navigator-toolbox:hover #nav-bar {
        opacity: 1 !important;
    }
    
    /* Create a hover area at the bottom for the nav bar */
    ...
    /* Remove browser margin since tabs are hidden */
    #browser {
        margin-bottom: var(--uc-bottom-toolbar-height) !important;
        margin-top: 0 !important;
    }

    /* Hide window controls and titlebar */
    ...
    /* Position nav bar at bottom when visible */
    #nav-bar {
    ...
    /* Hide most toolbar buttons for extreme minimalism */
    #back-button,
    #forward-button,
    #reload-button,
    #stop-button,
    ...
    /* Minimal URL bar dropdown */
    .urlbarView {
        font-size: var(--tab-font-size) !important;
        max-height: calc(60vh - 40pt) !important;
        overflow-y: auto !important;
        background: var(--toolbar-bgcolor, #2b2a33) !important;
        border: 1px solid var(--toolbar-border-color, #52525e) !important;
    ...
    /* Hide Firefox Suggest completely */
    ...
    /* Centered URL bar when expanded */
    ...
    /* Qutebrowser-style status indicator */
    #statuspanel {
        background: var(--toolbar-bgcolor, #2b2a33) !important;
        border: 1px solid var(--toolbar-border-color, #52525e) !important;
