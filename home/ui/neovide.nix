...
# Modern Neovim GUI with smooth animations and native performance
###############################################################################
{
  config,
  lib,
...
in {
  ...
  config = lib.mkIf cfg.enable {
    ...
    home.file.".config/neovide/config.toml".text = lib.generators.toTOML {} (lib.mkMerge [
      {
    ...
    home.file.".local/share/applications/neovide.desktop".text = ''
      [Desktop Entry]
      Type=Application
      Name=Neovide
