###############################################################################
# Marvel Rivals MarvelUserSettings.ini - Hjem Version
...
in {
  ...
  # Module Options
  ###########################################################################
  options.cfg.hjome.gaming.marvel-rivals.marvelusersettings = {
    enable = lib.mkOption {
      type = lib.types.bool;
      default = false;
  ...
  ###########################################################################
  config = lib.mkIf config.cfg.hjome.gaming.marvel-rivals.marvelusersettings.enable {
    ###########################################################################
