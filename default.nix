  ...
  nixosConfigurations.y0usaf-desktop = import (sources.nixpkgs + "/nixos") {
    ...
    configuration = {
      imports = [
        ...
        # ====================================================================
        # SHELL AND DEVELOPMENT TOOLS MODULE
        # ====================================================================
        # Comprehensive shell configuration including ZSH, Zellij, aliases,
        # and development tools like Git, Jujutsu, nh, and media tools
        ({
          config,
          pkgs,
          lib,
        ...
        # ====================================================================
        # USER INTERFACE AND DESKTOP ENVIRONMENT MODULE
        # ====================================================================
        # Complete desktop environment configuration including window managers
        # (Hyprland, Niri), GUI applications, theming, fonts, cursors, and
        # Wayland/X11 compatibility layer
        (
          {
            config,
            lib,
                    ...
                    ".config/niri/config.kdl" = {
                      text = ''
                        ...
                        binds {
                            ...
                            "Super+R" { spawn "foot" "-a" "launcher" "bash" "-c" "${config.user.configDirectory}/scripts/sway-launcher-desktop.sh"; }
                            "Mod+Q" { close-window; }
        ...
        # ====================================================================
        # HARDWARE SUPPORT AND GRAPHICS MODULE
        # ====================================================================
        # Hardware-specific configuration including NVIDIA/AMD graphics drivers,
        # Bluetooth, OpenGL/Vulkan, I2C, UDEV rules, and peripheral support
        ({
          config,
          lib,
          pkgs,
        ...
        # ====================================================================
        # APPLICATION PROGRAMS MODULE
        # ====================================================================
        # User application modules including media players, creative tools,
        # browsers, communication apps, and productivity software
        ({
          config,
          lib,
          pkgs,
        ...
        # ====================================================================
        # Complete development setup including Docker, AI tools (Claude, Gemini),
        # MCP servers, Node.js/NPM, Python, Neovim, IDEs, and development utilities
        (
          {
            config,
            lib,
        ...
        # ====================================================================
        # UTILITY TOOLS AND ARCHIVE MANAGERS MODULE
        # ====================================================================
        # Additional utility tools including archive managers and file handling tools
        ({
          config,
          lib,
          pkgs,
